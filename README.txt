...
This is a demo project for SIMC model checker. The program 'LeaderElection' does
...
We integrate SIMC to the LeaderElection. The model checker will run the cluster
...
4. Run ant to compile the LeaderElection program integrating with SIMC.
